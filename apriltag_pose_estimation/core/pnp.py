"""Utility functions and types for the SolvePnP algorithm."""
...
def solve_pnp(object_points: npt.NDArray[np.float64],
    ...
    Internally, this uses OpenCV's `solvePnPGeneric <https://docs.opencv.org/4.x/d5/d1f/calib3d_solvePnP.html>`
    function.

    :param object_points: A nx3 array of 3D points corresponding to positions of the tracked objects in the
                          world frame. If the PnP solver method being used is :py:const:`PnPMethod.IPPE`, this must be
    ...
    :param method: The method by which to solve the Perspective-N-Point problem
                   (default: :py:const:`PnPMethod.ITERATIVE`).
